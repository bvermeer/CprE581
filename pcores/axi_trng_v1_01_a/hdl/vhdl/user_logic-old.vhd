...
-- Date:              Sat Nov 22 21:25:34 2014 (by Create and Import Peripheral Wizard)
...
--  end generate BRAM_GEN;
  ...
  SLAVE_REG_READ_PROC : process( s_puf_ctl, s_puf_data,mem_address,s_hash_out_l,s_hash_out_h ) is
  begin
    case mem_address is
...
-- this process generates the read acknowledge 1 clock after read enable
  ...
  IP2Bus_AddrAck <= mem_write_ack or (s_rdy and mem_read_enable and mem_read_ack);
  IP2Bus_WrAck <= mem_write_ack;
  IP2Bus_RdAck <= s_rdy and mem_read_ack;
  IP2Bus_Error <= '0';
