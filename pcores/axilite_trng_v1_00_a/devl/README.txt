...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/ajmills/zedboard-trng
  logical library name                       : axilite_trng_v1_00_a
  top name                                   : axilite_trng
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- ISE project file(s)
  ...
  devl/projnav/axilite_trng.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/axilite_trng_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/axilite_trng_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/axilite_trng_v2_1_0.tcl
